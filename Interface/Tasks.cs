...
namespace Interface
{
    public partial class Tasks : Form
    {
        ...
        private static readonly string ibmApiKey = "c8b65b59-3726-4dd7-aea0-77449bce0206"; 
        ...
        private async Task LoadScheduledTasksAsync()
        {
            try
            {
                ...
                // Create a DataTable to hold task details
                ...
                foreach (var task in tasks)
                {
                    ...
                    // Track processes started by this task
                ...
                // Style the rows based on the "Is Suspicious" column
        ...
        private async Task<bool> IsTaskSuspiciousAsync(IRegisteredTask task)
        {
            ...
            foreach (IAction action in task.Definition.Actions)
            {
                if (action is IExecAction execAction)
                {
                    ...
                    // Check if the task is running from a suspicious path like user's roaming folder
                    ...
                    // Check if the task has no command-line arguments
                    ...
                    string fileHash = GetFileHash(path); // Implement GetFileHash to compute the hash of the file
        ...
        private void deleteButton_Click(object sender, EventArgs e)
        {
            try
            {
                // Prompt the user to confirm task deletion
        ...
        {
            var totalWidth = this.ClientSize.Width - 40; // Get the total width for the panel, with some padding
            var totalHeight = 50; // Fixed height for the panel

            // Create a panel to hold the bar
            barPanel = new Panel
            {
                Width = totalWidth,
                Height = totalHeight,
                Location = new System.Drawing.Point(20, 50), // Position below the title
                BorderStyle = BorderStyle.FixedSingle
            };

            this.Controls.Add(barPanel);

            // Add total count label below the bar
        ...
        // Example class for TCP connection information
        public class TcpConnectionInformationEx
        {
            ...
            public TcpConnectionInformationEx(MIB_TCPROW_OWNER_PID row)
            {
                ...
                OwningPid = (int)row.dwOwningPid;  // Explicit cast
            }
        }

        // P/Invoke declarations for getting TCP connections
    ...
    public static class XForceExchangeService
    {
        ...
        private static readonly string apiKey = "c8b65b59-3726-4dd7-aea0-77449bce0206"; 
