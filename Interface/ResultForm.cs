...
namespace Interface
{
    ...
    {
        private Form1 Form1;
        private const string HybridAnalysisApiKey = "j6763n5jfb8bdc8c1439rylm273773d60xx91ymx547cecfcb2qoqr1l93a0ed99";
       // private const string HybridAnalysisApiKey = "k0uacaby56115852bc70ub311625a368ov6uo7gm01ebb867peh1uwu5aa5480a6";
        ...
        {
            startup_programs_grid.ColumnCount = 11;
            startup_programs_grid.Columns[0].Name = "#";
            startup_programs_grid.Columns[0].Width = 20;
            startup_programs_grid.Columns[1].Name = "Name";
            startup_programs_grid.Columns[1].Width = 100;
            startup_programs_grid.Columns[2].Name = "Publisher";
            startup_programs_grid.Columns[2].Width = 70;
            startup_programs_grid.Columns[3].Name = "Path";
            startup_programs_grid.Columns[3].Width = 100;
            startup_programs_grid.Columns[4].Name = "Status";
            startup_programs_grid.Columns[4].Width = 50;
            startup_programs_grid.Columns[5].Name = "Status Impact";
            startup_programs_grid.Columns[5].Width = 50;
            startup_programs_grid.Columns[6].Name = "Type";
            startup_programs_grid.Columns[6].Width = 30;
            startup_programs_grid.Columns[7].Name = "File Version";
            startup_programs_grid.Columns[7].Width = 50;
            startup_programs_grid.Columns[8].Name = "Copyright";
            startup_programs_grid.Columns[8].Width = 60;
            startup_programs_grid.Columns[9].Name = "Size";
            startup_programs_grid.Columns[9].Width = 60;
            startup_programs_grid.Columns[10].Name = "Date Modified";
            startup_programs_grid.Columns[10].Width = 70;

            startup_programs_grid.BorderStyle = BorderStyle.None;
            startup_programs_grid.BackgroundColor = Color.White;
            startup_programs_grid.DefaultCellStyle.BackColor = Color.White;
            startup_programs_grid.DefaultCellStyle.ForeColor = Color.Black;
            startup_programs_grid.AlternatingRowsDefaultCellStyle.BackColor = Color.LightGray;
            startup_programs_grid.ColumnHeadersDefaultCellStyle.BackColor = System.Drawing.Color.FromArgb(45, 45, 48);
            startup_programs_grid.ColumnHeadersDefaultCellStyle.ForeColor = Color.White;
            startup_programs_grid.EnableHeadersVisualStyles = false;
            startup_programs_grid.GridColor = Color.LightGray;
        }
        ...
        {
            startup_programs_grid.Rows.Clear();
            programCounter = 1;
                ...
                using (RegistryKey key = baseKey.OpenSubKey(subKeyPath))
                {
                    if (key != null)
                    {
                        foreach (string valueName in key.GetValueNames())
                        {
                            ...
                            int rowIndex = startup_programs_grid.Rows.Add(startCounter++, fileInfo.Name, fileInfo.Publisher, fileInfo.Path, fileInfo.Status, fileInfo.StatusImpact, fileInfo.FileType, fileInfo.FileVersion, fileInfo.Copyright, fileInfo.Size, fileInfo.DateModified);

                            string reputation = await GetHybridAnalysisReputation(fileInfo.Path);
                            Color rowColor = GetRowColorFromReputation(reputation);
                            startup_programs_grid.Rows[rowIndex].DefaultCellStyle.BackColor = rowColor;
                        }
                    }
                    else
                    {
